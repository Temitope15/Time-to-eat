...
const AboutBanjo = () => {
  return (
    <section className=" mx-auto flex flex-col items-center justify-between my-4  md:flex-row font-tertiary pt-24">
      ...
      <div className="max-w-md space-y-2">
        <h1 className="text-lg font-bold text-center font-secondary text-blue-500 md:text-3xl md:mb-2">
